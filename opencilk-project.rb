...
class OpencilkProject < Formula
  desc "Monorepo for the OpenCilk compiler.  Forked from llvm/llvm-project and based on Tapir/LLVM."
  homepage "https://www.opencilk.org/"
  url "https://github.com/OpenCilk/opencilk-project/archive/refs/heads/dev/18.x.zip"
  ...
  head "https://github.com/OpenCilk/opencilk-project.git", branch: "dev/18.x"
